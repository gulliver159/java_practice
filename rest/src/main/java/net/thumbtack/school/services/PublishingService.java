...
public class PublishingService {
    ...
    public void remove(Recording recording, ZonedDateTime publishAvailableDate) {
        if (recording.getTrackType() == TrackType.AUDIO) {
            itunesChannel.remove(recording, publishAvailableDate);
            yandexMusicChannel.remove(recording, publishAvailableDate);
            youtubeMusicChannel.remove(recording, publishAvailableDate);
        }
        else {
            youtubeMusicChannel.remove(recording, publishAvailableDate);
        }
